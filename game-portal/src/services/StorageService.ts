...
export const GAME_META: Record<GameType, GameMeta> = {
  ...
  [GameType.ALCHEMY_MASTER]: {
    type: GameType.ALCHEMY_MASTER,
    name: '炼金大师',
    description: '调配药剂，炼制神器，成为传奇炼金术士！',
    icon: '⚗️',
    color: '#A855F7',
    gradient: 'from-purple-600 to-indigo-500',
    controls: '空格/点击 炼金 · ↑↓ 选择配方 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.CIV_BABYLON]: {
    type: GameType.CIV_BABYLON,
    name: '巴比伦文明',
    description: '建造空中花园，发展两河文明，成就帝国霸业！',
    icon: '🏛️',
    color: '#F59E0B',
    gradient: 'from-amber-500 to-yellow-400',
    controls: '空格/点击 建造 · ↑↓ 选择建筑 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.CIV_CHINA]: {
    type: GameType.CIV_CHINA,
    name: '华夏文明',
    description: '发展农耕丝织，建设万里长城，缔造华夏盛世！',
    icon: '🐉',
    color: '#EF4444',
    gradient: 'from-red-500 to-rose-400',
    controls: '空格/点击 发展 · ↑↓ 选择项目 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.CIV_EGYPT]: {
    type: GameType.CIV_EGYPT,
    name: '埃及文明',
  ...
  [GameType.CLAN_SAGA]: {
    type: GameType.CLAN_SAGA,
    name: '氏族传说',
    description: '统领氏族，征战四方，书写属于你的传奇！',
    icon: '⚔️',
    color: '#D97706',
    gradient: 'from-amber-600 to-stone-500',
    controls: '空格/点击 征战 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.DOOMSDAY]: {
    type: GameType.DOOMSDAY,
    name: '末日求生',
    description: '核战之后，收集资源，建立避难所，重建文明！',
    icon: '☢️',
    color: '#22C55E',
    gradient: 'from-green-500 to-lime-400',
    controls: '空格/点击 收集 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.DUNGEON_EXPLORE]: {
    type: GameType.DUNGEON_EXPLORE,
    name: '地牢探索',
    description: '深入地下城，击败怪物，收集宝藏和装备！',
    icon: '🏰',
    color: '#A8A29E',
    gradient: 'from-stone-500 to-zinc-400',
    controls: '空格/点击 探索 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.ISLAND_DRIFT]: {
    type: GameType.ISLAND_DRIFT,
    name: '荒岛漂流',
    description: '流落荒岛，采集资源，建造庇护所，等待救援！',
    icon: '🏝️',
    color: '#22D3EE',
    gradient: 'from-cyan-500 to-teal-400',
    controls: '空格/点击 采集 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.MODERN_CITY]: {
    type: GameType.MODERN_CITY,
    name: '现代都市',
  ...
  [GameType.SPACE_DRIFT]: {
    type: GameType.SPACE_DRIFT,
    name: '星际漂流',
    description: '驾驶飞船，开采小行星，探索无尽宇宙！',
    icon: '🚀',
    color: '#6366F1',
    gradient: 'from-indigo-500 to-violet-400',
    controls: '空格/点击 开采 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.TRIBULATION]: {
    type: GameType.TRIBULATION,
    name: '天劫修仙',
  ...
  [GameType.WILD_SURVIVAL]: {
    type: GameType.WILD_SURVIVAL,
    name: '荒野求生',
  ...
  [GameType.AGE_OF_EMPIRES]: {
    type: GameType.AGE_OF_EMPIRES,
    name: '帝国时代',
  ...
  [GameType.BALDURS_GATE]: {
    type: GameType.BALDURS_GATE,
    name: '博德之门',
  ...
  [GameType.EGYPT_MYTH]: {
    type: GameType.EGYPT_MYTH,
    name: '埃及神话',
    description: '召唤埃及众神，建造神庙，统治沙漠王国！',
    icon: '🐪',
    color: '#F59E0B',
    gradient: 'from-amber-500 to-yellow-400',
    controls: '空格/点击 召唤 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.FINAL_FANTASY]: {
    type: GameType.FINAL_FANTASY,
    name: '最终幻想',
  ...
  [GameType.GREEK_GODS]: {
    type: GameType.GREEK_GODS,
    name: '希腊众神',
    description: '信仰奥林匹斯众神，建设城邦，成就希腊霸业！',
    icon: '⚡',
    color: '#EAB308',
    gradient: 'from-yellow-500 to-amber-400',
    controls: '空格/点击 建造 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.HEROES_MIGHT]: {
    type: GameType.HEROES_MIGHT,
    name: '英雄无敌',
    description: '招募英雄，建设城堡，征服魔法大陆！',
    icon: '🏇',
    color: '#8B5CF6',
    gradient: 'from-violet-500 to-purple-400',
    controls: '空格/点击 招募 · ↑↓ 选择行动 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.NORSE_VALKYRIE]: {
    type: GameType.NORSE_VALKYRIE,
    name: '北欧女武神',
  ...
  [GameType.THREE_KINGDOMS]: {
    type: GameType.THREE_KINGDOMS,
    name: '三国霸业',
  ...
  [GameType.YOKAI_NIGHT]: {
    type: GameType.YOKAI_NIGHT,
    name: '百鬼夜行',
