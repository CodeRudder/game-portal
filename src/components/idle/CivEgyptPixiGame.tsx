/**
 * components/idle/CivEgyptPixiGame.tsx — 古埃及文明放置游戏 PixiJS React 组件
 *
 * 使用 PixiGameAdapter + CivEgyptStrategy 渲染古埃及文明游戏。
 * 金沙配色主题，金字塔/神殿建筑风格。
 *
...
export default function CivEgyptPixiGame({
  ...
  return (
    <div ref={containerRef} className={className} data-testid="civ-egypt-pixi-game" style={{
      width: '100%', height: '100%', position: 'relative', overflow: 'hidden',
      background: '#1a1408', ...style,
    }}>
      {loading && (
        <div style={{
          position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column',
          alignItems: 'center', justifyContent: 'center', color: '#a89868', fontSize: 14, gap: 8,
        }}>
