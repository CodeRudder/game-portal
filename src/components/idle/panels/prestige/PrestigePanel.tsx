...
const s: Record<string, React.CSSProperties> = {
  ...
  card: { padding: 16, marginBottom: 16, borderRadius: 10, textAlign: 'center', background: 'linear-gradient(135deg, rgba(212,165,116,0.12), rgba(212,165,116,0.04))', border: '1px solid rgba(212,165,116,0.25)' },
  ...
  barBg: { height: 8, borderRadius: 4, background: 'rgba(255,255,255,0.08)', overflow: 'hidden', marginBottom: 4 },
  barFill: { height: '100%', borderRadius: 4, background: 'linear-gradient(90deg, #d4a574, #e8c49a)' },
  progText: { fontSize: 11, color: '#a0a0a0' },
  section: { marginBottom: 16 },
  sectionTitle: { fontSize: 14, fontWeight: 600, color: '#d4a574', marginBottom: 8 },
  srcRow: { display: 'flex', justifyContent: 'space-between', padding: '6px 10px', background: 'rgba(255,255,255,0.03)', borderRadius: 6, fontSize: 12, marginBottom: 4 },
  rwItem: { display: 'flex', alignItems: 'center', gap: 8, padding: 10, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 8, marginBottom: 6 },
  claimBtn: { padding: '4px 12px', border: '1px solid rgba(212,165,116,0.3)', borderRadius: 4, background: 'rgba(212,165,116,0.15)', color: '#d4a574', fontSize: 11, cursor: 'pointer' },
