...
const S: Record<string, React.CSSProperties> = {
  ...
  progressBar: { flex: 1, height: 8, background: 'rgba(255,255,255,0.08)', borderRadius: 'var(--tk-radius-sm)' as any, overflow: 'hidden' },
  progressFill: { height: '100%', background: 'linear-gradient(90deg,#d4a574,#7EC850)', borderRadius: 'var(--tk-radius-sm)' as any, transition: 'width 0.3s' },
  ...
  btnSmall: { padding: '4px 10px', borderRadius: 'var(--tk-radius-sm)' as any, border: '1px solid rgba(212,165,116,0.3)', background: 'rgba(212,165,116,0.1)', color: '#d4a574', fontSize: 12, cursor: 'pointer' },
  bottomBar: { display: 'flex', gap: 8, marginTop: 12 },
  btnAction: { flex: 1, padding: '8px 12px', borderRadius: 'var(--tk-radius-lg)' as any, border: '1px solid rgba(255,255,255,0.1)', color: '#e8e0d0', fontSize: 13, cursor: 'pointer', transition: 'background 0.2s' },
  ...
  modal: { background: '#2a2520', borderRadius: 'var(--tk-radius-xl)' as any, padding: 20, minWidth: 300, maxWidth: 400, border: '1px solid rgba(212,165,116,0.3)' },
