...
const S: Record<string, React.CSSProperties> = {
  ...
  powerRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 12px', marginBottom: 8, borderRadius: 8, background: 'rgba(212,165,116,0.08)', border: '1px solid rgba(212,165,116,0.2)' },
  ...
  factionBadge: { padding: '2px 8px', borderRadius: 4, background: 'rgba(255,255,255,0.06)', fontSize: 12, color: '#c0b8a8' },
  formationBox: { padding: 12, marginBottom: 14, borderRadius: 10, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' },
  ...
  slotCard: { width: 90, height: 56, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: 8, border: '1px solid', background: 'rgba(255,255,255,0.03)', cursor: 'pointer', transition: 'border-color 0.2s' },
  ...
  heroCard: { padding: '8px 10px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 6, cursor: 'pointer', transition: 'background 0.2s' },
  empty: { textAlign: 'center', color: '#a0a0a0', fontSize: 13, padding: 16 },
  bottomBar: { display: 'flex', gap: 8, marginTop: 12 },
  btnPrimary: { flex: 1, padding: '8px 12px', borderRadius: 8, border: 'none', background: 'linear-gradient(135deg,#d4a574,#b8864a)', color: '#fff', fontSize: 13, cursor: 'pointer', fontWeight: 600 },
  btnSecondary: { flex: 1, padding: '8px 12px', borderRadius: 8, border: '1px solid rgba(212,165,116,0.3)', background: 'rgba(212,165,116,0.1)', color: '#d4a574', fontSize: 13, cursor: 'pointer' },
};
