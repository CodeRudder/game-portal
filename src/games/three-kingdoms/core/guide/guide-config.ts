...
export const EXTENDED_STEP_DEFINITIONS: TutorialStepDefinition[] = [
  ...
  },
  {
    ...
    triggerCondition: { type: 'first_alliance', value: 1 },
    rewards: [{ type: 'currency', rewardId: 'copper', name: '铜钱', amount: 200 }],
  },
  {
    ...
    triggerCondition: { type: 'bag_capacity', value: 80 },
    rewards: [{ type: 'currency', rewardId: 'copper', name: '铜钱', amount: 200 }],
  },
  {
  ...
  },
  {
    ...
    triggerCondition: { type: 'building_level', value: 8 },
...
export const STORY_EVENT_DEFINITIONS: StoryEventDefinition[] = [
  ...
  },
  {
    ...
    title: '黄巾之乱',
    dialogues: [
      { speaker: '', text: '黄巾贼张角率众作乱，烧杀抢掠，百姓苦不堪言。' },
      { speaker: '探子', text: '报——！黄巾贼寇已逼近城池，请主公定夺！' },
      { speaker: '刘备', text: '贼寇猖獗，百姓受苦。我等岂能坐视不理？' },
      { speaker: '关羽', text: '兄长勿忧，待关某提青龙偃月刀，取贼首级！' },
      { speaker: '张飞', text: '哈哈哈！终于可以大干一场了！' },
      { speaker: '', text: '主公，整军出征，击退黄巾！' },
    ],
  ...
  },
  {
    ...
    title: '七擒孟获',
    dialogues: [
      { speaker: '', text: '七擒七纵，攻心为上。诸葛亮以仁德收服南蛮。' },
      { speaker: '诸葛亮', text: '有些选择，一旦做出便不可回头。' },
      { speaker: '诸葛亮', text: '科技之路亦是如此——选择攻心，则武力之路封闭；反之亦然。' },
      { speaker: '孟获', text: '丞相恩威并施，孟获心服口服！' },
      { speaker: '', text: '科技分支选择——请主公三思而后行。' },
    ],
    estimatedDurationMs: 35000,
    triggerCondition: { type: 'tech_count', value: 4 },
    rewards: [{ type: 'currency', rewardId: 'copper', name: '铜钱', amount: 300 }],
  },
  {
    ...
    title: '三国归一',
    dialogues: [
      { speaker: '', text: '天下大势，分久必合。主公的征途，才刚刚开始。' },
      { speaker: '刘备', text: '感谢主公一路相伴。前路漫漫，我等愿继续追随！' },
      { speaker: '诸葛亮', text: '主公已掌握治国之道。更多策略与挑战，等待您去探索。' },
      { speaker: '', text: '日常任务、限时活动、联盟战争……更多精彩即将开启。' },
      { speaker: '', text: '愿主公——一统天下，开创盛世！' },
    ],
    estimatedDurationMs: 40000,
...
export const TUTORIAL_PHASE_REWARDS: TutorialPhaseReward[] = [
  ...
  },
  {
    ...
    rewards: [
      ...
      { type: 'package', rewardId: 'blue_equipment_box', name: '蓝色装备箱', amount: 1 },
