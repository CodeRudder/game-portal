 ...
 * - 效果缓存机制，科技完成时刷新
 *
 * @module engine/tech/TechEffectSystem
 */
...
/** 军事效果类型到统计项的映射 */
const MILITARY_EFFECT_MAP: Record<string, MilitaryStat> = {
  troop_attack: 'attack',
...
/** 经济效果类型到统计项的映射 */
const ECONOMY_EFFECT_MAP: Record<string, EconomyStat> = {
  resource_production: 'production',
  resource_cap: 'storage',
};

/** 文化效果类型到统计项的映射 */
const CULTURE_EFFECT_MAP: Record<string, CultureStat> = {
  hero_exp: 'expBonus',
