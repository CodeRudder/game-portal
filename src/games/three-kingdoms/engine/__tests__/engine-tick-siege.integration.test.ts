...
function createMockTickCtx(overrides: Partial<TickContext> = {}): TickContext {
  ...
  return {
    ...
    calendar: createMockSystem() as any,
    hero: createMockSystem() as any,
    campaign: createMockSystem() as any,
    techTree: { getTechBonusMultiplier: vi.fn().mockReturnValue(1), getEffectValue: vi.fn().mockReturnValue(0) } as any,
    techPoint: { syncAcademyLevel: vi.fn(), update: vi.fn(), syncResearchSpeedBonus: vi.fn() } as any,
    techResearch: { update: vi.fn() } as any,
    eventTrigger: createMockSystem() as any,
    eventNotification: createMockSystem() as any,
    eventUI: createMockSystem() as any,
    eventChain: createMockSystem() as any,
    eventLog: createMockSystem() as any,
    offlineEvent: createMockSystem() as any,
