...
describe('offline-utils', () => {
  ...
  describe('cloneRes', () => {
    it('应返回独立副本', () => {
      const r: Resources = { grain: 10, gold: 20, ore: 0, wood: 0, troops: 30, mandate: 5, techPoint: 1, recruitToken: 2, skillBook: 3 };
      const c = cloneRes(r);
      expect(c).toEqual(r);
      c.grain = 999;
  ...
  describe('addRes', () => {
    it('应正确相加', () => {
      const a: Resources = { grain: 10, gold: 20, ore: 0, wood: 0, troops: 30, mandate: 5, techPoint: 1, recruitToken: 2, skillBook: 3 };
      const b: Resources = { grain: 5, gold: 10, ore: 0, wood: 0, troops: 15, mandate: 2, techPoint: 1, recruitToken: 1, skillBook: 1 };
  ...
  describe('floorRes', () => {
    it('应向下取整', () => {
      const r: Resources = { grain: 10.9, gold: 20.1, ore: 0.5, wood: 1.7, troops: 30.5, mandate: 5.99, techPoint: 1.1, recruitToken: 2.8, skillBook: 3.3 };
