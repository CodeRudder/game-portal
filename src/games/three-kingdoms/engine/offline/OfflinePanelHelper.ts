...
export function estimateOfflineReward(
  ...
  let totalEarned: Resources = { grain: 0, gold: 0, troops: 0, mandate: 0, techPoint: 0, recruitToken: 0, skillBook: 0, ore: 0, wood: 0 };
  let totalWeighted = 0;
  ...
  for (const tier of DECAY_TIERS) {
    ...
    const earned: Resources = { grain: 0, gold: 0, troops: 0, mandate: 0, techPoint: 0, recruitToken: 0, skillBook: 0, ore: 0, wood: 0 };
  ...
  totalEarned = {
    ...
    ore: Math.floor(totalEarned.ore * bonusCoefficient),
    wood: Math.floor(totalEarned.wood * bonusCoefficient),
