...
export const GAME_META: Record<GameType, GameMeta> = {
  ...
  [GameType.HEX]: {
    ...
    controls: '方向键移动光标 · 空格落子 · S 交换（Swap Rule）',
    difficulty: '中等',
  },
  [GameType.RHYTHM]: {
    type: GameType.RHYTHM,
    name: '音乐节拍',
    description: '音符从顶部下落到判定线，在正确时机按键得分！Perfect/Great/Good判定，连击倍率加成，健康值归零则游戏结束！',
    icon: '🎵',
    color: '#ec4899',
    gradient: 'from-pink-500 to-purple-500',
    controls: 'D/F/J/K 对应4轨道 · 空格 开始 · 把握节奏精准按键',
    difficulty: '中等',
  },
  [GameType.DOODLE_GOD]: {
    type: GameType.DOODLE_GOD,
    name: '涂鸦上帝',
    description: '组合基础元素创造新事物！从水、火、土、气开始，探索数百种合成配方，成为造物主！',
    icon: '🔬',
    color: '#a855f7',
    gradient: 'from-purple-500 to-violet-500',
    controls: '方向键选择元素 · 空格/回车确认 · 合成两个元素创造新发现',
    difficulty: '简单',
  },
  [GameType.CHESS]: {
    type: GameType.CHESS,
    ...
    controls: '方向键 移动光标 · 空格 选择/落子 · Q 取消',
    difficulty: '困难',
  },
  [GameType.STICK_FIGHTER]: {
    type: GameType.STICK_FIGHTER,
    name: '双人格斗',
    description: '火柴人格斗对战！拳击、踢腿、防御、跳跃，击败对手赢得胜利！',
    icon: '🥊',
    color: '#f87171',
    gradient: 'from-red-400 to-orange-400',
    controls: 'P1: WASD移动 · F拳击 · G踢腿 · S防御 | P2: 方向键 · K拳击 · L踢腿 · ↓防御',
    difficulty: '中等',
  },
  [GameType.SLITHER_IO]: {
    type: GameType.SLITHER_IO,
    name: '虫虫大作战',
    description: '控制虫子吃食物变长，包围对手使其撞上你的身体！Shift 加速消耗身体，策略与操作并重！',
    icon: '🐛',
    color: '#a3e635',
    gradient: 'from-lime-400 to-green-400',
    controls: '← → 转向 · Shift 加速（消耗身体） · 空格 开始',
    difficulty: '中等',
  },
  [GameType.FREECELL]: {
    type: GameType.FREECELL,
    name: '空当接龙',
    description: '经典 FreeCell 纸牌！利用4个自由单元格和4个基础堆，将52张牌按花色从A到K完成排序！',
    icon: '🂠',
    color: '#22c55e',
    gradient: 'from-green-500 to-teal-400',
    controls: '方向键导航 · 空格选择/放置 · A 自动完成 · 1-4 基础堆 · Esc 取消选择',
    difficulty: '中等',
  },
  [GameType.FOLD_PUZZLE]: {
    type: GameType.FOLD_PUZZLE,
    name: '折纸拼图',
  ...
  [GameType.SLOPE_BALL]: {
    ...
    name: '滚球跑酷',
    description: '控制球在斜坡上滚动，左右躲避障碍物，速度越来越快！距离越远分数越高！',
    icon: '⚽',
    color: '#00ff88',
    gradient: 'from-green-400 to-cyan-400',
    controls: '← → / A D 左右移动 · 躲避障碍物 · 速度逐渐递增',
    difficulty: '中等',
  },
  [GameType.CHINESE_CHESS]: {
    type: GameType.CHINESE_CHESS,
    name: '象棋',
    description: '经典中国象棋，楚河汉界，车马炮兵各显神通。支持人机对战，挑战智能AI！',
    icon: '♟',
    color: '#ef4444',
    gradient: 'from-red-500 to-amber-400',
    controls: '方向键移动光标 · 空格选择/落子 · Q 取消',
    difficulty: '困难',
  },
  [GameType.TEMPLE_RUN]: {
    type: GameType.TEMPLE_RUN,
    name: '神庙逃亡',
    description: '三跑道跑酷！左右切换跑道，跳跃和滑铲躲避障碍，收集金币，速度递增挑战极限！',
    icon: '🏃',
    color: '#f59e0b',
    gradient: 'from-amber-500 to-red-400',
    controls: '← → / A D 切换跑道 · ↑ / W / 空格 跳跃 · ↓ / S 滑铲',
    difficulty: '中等',
  },
  [GameType.SENET]: {
    type: GameType.SENET,
    ...
    controls: 'T 掷棍 · 方向键移动光标 · 空格确认',
    difficulty: '中等',
  },
  [GameType.BASKETBALL_HOOPS]: {
    type: GameType.BASKETBALL_HOOPS,
    name: '疯狂投篮',
    description: '调节角度和力度投篮，连续进球有奖励倍率！空心入网3分，60秒挑战最高分！',
    icon: '🏀',
    color: '#ff8c00',
    gradient: 'from-orange-500 to-red-400',
    controls: '↑↓ 调节角度 · 空格 蓄力/投篮 · 连续进球有奖励',
    difficulty: '中等',
  },
  [GameType.FLAPPY_PLANE]: {
    type: GameType.FLAPPY_PLANE,
    name: '飞行小鸟',
    description: '控制飞机穿越上下障碍物，收集星星加分！速度逐渐递增，间隙逐渐缩小，挑战你的反应极限！',
    icon: '✈️',
    color: '#00b4d8',
    gradient: 'from-cyan-500 to-blue-500',
    controls: '↑↓ / WS 控制飞机上下移动 · 穿越障碍得分 · 收集星星加分',
    difficulty: '中等',
  },
  [GameType.JIGSAW_PUZZLE]: {
    type: GameType.JIGSAW_PUZZLE,
    name: '拼图游戏',
    description: '将打乱的拼图碎片拖拽到正确位置，完成拼图！4×4网格，多个图案可选，考验你的观察力和耐心！',
    icon: '🧩',
    color: '#f59e0b',
    gradient: 'from-amber-500 to-orange-400',
    controls: '方向键移动光标 · 空格选择/放置 · Tab切换区域 · R重置 · N切换图案',
    difficulty: '中等',
  },
  [GameType.BLOONS]: {
    type: GameType.BLOONS,
    name: '打气球',
    description: '控制准星投掷飞镖击破沿路径移动的气球！放置飞镖猴自动攻击，10关挑战，多种气球类型！',
    icon: '🎈',
    color: '#ff4444',
    gradient: 'from-red-500 to-pink-500',
    controls: 'WASD/方向键移动准星 · 空格投掷飞镖 · T放置飞镖猴 · N下一关',
    difficulty: '中等',
  },
  [GameType.CTF]: {
    type: GameType.CTF,
    ...
    color: '#f59e0b',
    gradient: 'from-amber-500 to-red-400',
    controls: '方向键/WASD 移动 · 空格 抢旗/释放 · 碰到持旗对手夺回旗帜',
    difficulty: '中等',
  },
  [GameType.BACKGAMMON]: {
    type: GameType.BACKGAMMON,
    name: '双陆棋',
    description: '经典双陆棋 Backgammon！掷骰子移动棋子，将所有棋子移到己方内盘后归巢获胜。打子、归巢、双骰，策略与运气并重！',
    icon: '🎲',
    color: '#f59e0b',
    gradient: 'from-amber-500 to-orange-400',
    controls: '空格/D 掷骰子 · 方向键选择点位 · 空格确认 · Esc 取消',
    difficulty: '中等',
  },
  [GameType.PONG_2P]: {
    type: GameType.PONG_2P,
    name: '双人乒乓球',
    description: '经典双人乒乓球对战！P1用W/S控制，P2用↑/↓控制，先到11分且领先2分获胜，支持AI模式！',
    icon: '🏓',
    color: '#4fc3f7',
    gradient: 'from-cyan-500 to-blue-400',
    controls: 'P1: W/S 上下移动 · P2: ↑/↓ 上下移动 · T 切换AI模式',
    difficulty: '中等',
  },
  [GameType.HEAD_SOCCER]: {
    type: GameType.HEAD_SOCCER,
    name: '顶球对战',
    description: '双人顶球足球对战！用头和身体顶球、踢球，先到5分获胜，支持AI对手！',
    icon: '⚽',
    color: '#22c55e',
    gradient: 'from-green-500 to-emerald-400',
    controls: 'P1: A/D 移动 · W 跳跃 · S 踢球 | P2: ←→ 移动 · ↑ 跳跃 · ↓ 踢球',
    difficulty: '中等',
  },
  [GameType.MAHJONG_SOLITAIRE]: {
    type: GameType.MAHJONG_SOLITAIRE,
    name: '麻将消除',
    description: '经典麻将消除游戏！选择配对的自由麻将牌进行消除，清除所有牌即可过关！',
    icon: '🀄',
    color: '#14b8a6',
    gradient: 'from-teal-500 to-cyan-500',
    controls: '点击选择配对的麻将牌 · H 提示 · U 撤销',
    difficulty: '中等',
  },
  [GameType.SPACE_WAR]: {
    type: GameType.SPACE_WAR,
    name: '双人射击',
    description: '双人飞船太空对决！旋转推进射击，屏幕包裹，3局2胜，支持AI模式！',
    icon: '🚀',
    color: '#22d3ee',
    gradient: 'from-cyan-400 to-purple-400',
    controls: 'P1: W推进 A/D旋转 空格射击 · P2: ↑推进 ←→旋转 Enter射击 · T切换AI',
    difficulty: '中等',
  },
  [GameType.DUCK_HUNT]: {
    type: GameType.DUCK_HUNT,
    name: '打鸭子',
    description: '经典光枪射击！用准星瞄准射击飞过的鸭子，别让它们跑掉！支持多轮挑战。',
    icon: '🦆',
    color: '#f59e0b',
    gradient: 'from-amber-500 to-green-400',
    controls: '方向键/WASD 移动准星 · 空格 射击 · 击中鸭子得分',
    difficulty: '简单',
  },
  [GameType.FISHING_MASTER]: {
    type: GameType.FISHING_MASTER,
    name: '钓鱼大师',
    description: '在湖边悠闲钓鱼！控制鱼钩深度，等待鱼儿上钩，不同鱼种不同分数！',
    icon: '🎣',
    color: '#3b82f6',
    gradient: 'from-blue-500 to-cyan-400',
    controls: '↑↓ 收放鱼线 · 空格 抛竿/收竿 · 等待鱼上钩',
    difficulty: '简单',
  },
  [GameType.NINJA_JUMP]: {
    type: GameType.NINJA_JUMP,
    name: '忍者跳跃',
    description: '操控忍者不断向上跳跃！踩踏平台攀升，躲避障碍物，挑战最高纪录！',
    icon: '🥷',
    color: '#a855f7',
    gradient: 'from-purple-500 to-red-400',
    controls: '← → / A D 左右移动 · 自动跳跃 · 踩平台上升',
    difficulty: '中等',
  },
  [GameType.NONOGRAM]: {
    type: GameType.NONOGRAM,
    name: '数织',
    description: '经典逻辑填色益智！根据行列数字提示推理出隐藏图案，考验你的逻辑思维！',
    icon: '🔲',
    color: '#6366f1',
    gradient: 'from-indigo-500 to-blue-500',
    controls: '方向键移动光标 · 空格 填充/标记 · X 标记空格 · Z 撤销 · R 重置',
    difficulty: '中等',
  },
  [GameType.SKI_FREE]: {
    type: GameType.SKI_FREE,
    name: '滑雪大冒险',
    description: '在雪山上自由滑雪！躲避树木和障碍物，速度越来越快，看你能滑多远！',
    icon: '⛷',
    color: '#22d3ee',
    gradient: 'from-cyan-400 to-white/50',
  ...
  [GameType.DOGGO_HOME]: {
    type: GameType.DOGGO_HOME,
    name: '狗狗家园',
    description: '收集各种可爱狗狗，升级建筑，打造温馨的狗狗家园！',
    icon: '🐕',
    color: '#F59E0B',
    gradient: 'from-amber-500 to-yellow-400',
    controls: '空格/点击 收集 · ↑↓ 选择升级 · Enter 购买',
    difficulty: '简单',
  },
  [GameType.KITTENS_KINGDOM]: {
    type: GameType.KITTENS_KINGDOM,
    name: '猫咪王国',
    description: '点击产鱼干，解锁猫咪品种，建设你的猫咪王国！',
    icon: '🐱',
    color: '#F97316',
    gradient: 'from-orange-500 to-amber-400',
    controls: '空格/点击 产鱼干 · ↑↓ 选择升级 · Enter 购买',
    difficulty: '简单',
  },
  [GameType.PENGUIN_EMPIRE]: {
    type: GameType.PENGUIN_EMPIRE,
    name: '企鹅帝国',
    description: '收集冰块，建造设施，征服南极大陆！',
    icon: '🐧',
    color: '#3B82F6',
    gradient: 'from-blue-500 to-cyan-400',
    controls: '空格/点击 收集冰块 · ↑↓ 选择升级 · Enter 购买',
    difficulty: '简单',
  },
  [GameType.ANT_KINGDOM]: {
    type: GameType.ANT_KINGDOM,
    name: '蚂蚁王国',
    description: '建立蚁巢，繁殖工蚁，打造地下蚂蚁帝国！',
    icon: '🐜',
    color: '#92400E',
    gradient: 'from-amber-800 to-yellow-700',
    controls: '空格/点击 收集资源 · ↑↓ 选择升级 · Enter 购买',
    difficulty: '简单',
  },
  [GameType.DINO_RANCH]: {
    type: GameType.DINO_RANCH,
    name: '恐龙牧场',
  ...
  [GameType.IDLE_XIANXIA]: {
    type: GameType.IDLE_XIANXIA,
    name: '修仙放置',
    description: '修炼灵气，突破境界，踏上修仙之路！',
    icon: '🏔️',
    color: '#8B5CF6',
    gradient: 'from-purple-500 to-indigo-400',
    controls: '空格/点击 修炼 · ↑↓ 选择功法 · Enter 确认',
    difficulty: '简单',
  },
  [GameType.SECT_RISE]: {
    type: GameType.SECT_RISE,
    name: '宗门崛起',
    description: '创建宗门，招收弟子，成就修仙霸业！',
    icon: '⚔️',
    color: '#EF4444',
    gradient: 'from-red-500 to-rose-400',
    controls: '空格/点击 经营 · ↑↓ 选择建筑 · Enter 确认',
    difficulty: '简单',
  },
};
